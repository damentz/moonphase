...
#ifndef   ABOUTWIDGETPLUGIN_H
#define   ABOUTWIDGETPLUGIN_H
    ...
    public QObject, public QDesignerCustomWidgetInterface
{
  ...
  public:
    ...
    **/
    ABOUTWIDGETPLUGIN_C(QObject *pParent=NULL);
    /**
